...
<div class="container" style="margin-top:80px">
	...
	<div class="row">
		...
		<div class="col-md-6 border">
				...
				<?= form_open_multipart('admin/editarticle/'. $article["id"] ); ?>
				<label for="email" class="col-sm-4 col-form-label">Article Title :</label>

				<?= form_input(['type' => 'text', 'class' => 'form-control', 'placeholder' => 'Enter Title', 'name' => 'title', 'value' => set_value('title', $article["article_title"] )]); ?>
				<span class="text-danger"><?= form_error('title') ?></span>
				
				<label for="inputPassword" class="col-sm-3 col-form-label">Article Body : </label>
				<?= form_textarea(['rows' => 3,  'class' => 'form-control', 'placeholder' => 'Enter Body', 'name' => 'body', 'value' => set_value('body', $article["article_body"])]); ?>
				<span class="text-danger"><?= form_error('body') ?></span><br/>

				<label for="inputPassword" class="col-sm-3 col-form-label">Article Image : </label>
				<img src="<?= $article["image_path"] ?>" alt="Article Image" width="200" height="160"><br/>
				...
				<br/>
				<?= form_submit(['type' => 'submit', 'class' => 'btn btn-outline-success', 'value'=> 'Update']); ?>
